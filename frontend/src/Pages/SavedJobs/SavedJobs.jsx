  ...
  return (
    <div className="max-w-7xl mx-auto ">
      <div className="flex w-full my-6 justify-between flex-col lg:flex-row">
        <div className="lg:w-1/4 text-3xl text-blue-700 p-2">
          Saved Applicant
        </div>
      ...
      {isDropdownVisible && (
        ...
        // <div
        //   className="absolute right-0 bg-white border border-solid border-blue-700 rounded-lg shadow-md"
        //   style={{ width: "10%", right: "10%", top: "20%" }}
        // >
